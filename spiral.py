...
class SphericalSpiral:
    ...
    def reconstruct_surface_mesh(self):
        ...
        self.mesh = o3d.geometry.TriangleMesh.create_from_point_cloud_ball_pivoting(pcd, o3d.utility.DoubleVector(radii))
        ...
        if hasattr(self, 'original_mesh_poisson') and hasattr(self, 'mesh_poisson'):
            ...
            for triangle in triangles:
                for i in range(3):
                    ...
                    ax1.plot([start_point[0], end_point[0]], [start_point[1], end_point[1]], [start_point[2], end_point[2]], 'k', linewidth=0.5)
            ...
            for triangle in triangles:
                for i in range(3):
                    start_point = vertices[triangle[i]]
                    end_point = vertices[triangle[(i + 1) % 3]]
                    ax2.plot([start_point[0], end_point[0]], [start_point[1], end_point[1]], [start_point[2], end_point[2]], 'k', linewidth=0.5)
